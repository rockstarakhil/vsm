...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>VSM Educaion Instutions</title>
                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><img src="assest/img/logo1.png" alt="logo"></a>
                        </div>
...
for (var i = 0; i < btns.length; i++) {
  ...
  <!--  <section class="features-top-area" id="features">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="single-fun-fact mb30 wow fadeInUp" data-wow-delay="0.3s">
                        <h3 class="font60 xs-font26"><span class="counter">28</span></h3>
                        <p class="font600">Courses Offered</p>
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-xs-12">
            ...
            <div class="row">
                <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                    <div class="area-title text-center wow fadeIn">
                        <h2 class="xs-font26">Our Courses</h2>
                    </div>
                </div>
            </div>
   ...
   <ul><section class="section-padding about-area" id="about">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-blog-item wow fadeInUp visible-sm" data-wow-delay="0.4s">
                        ...
                        <div class="blog-details padding30">
                            <h3 class="blog-title font20 mb30"><a href="blog.html">CULTURALS</a></h3>
                            <p class="blog-meta font14 mt20"><a href="#">Feb 01, 2020</a> by <a href="#">Corona</a></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3818.6800293948527!2d82.0166268648688!3d16.842222338407485!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a37922276e39301%3A0x3462ceb7b20a458c!2sVSM%20College!5e0!3m2!1sen!2sin!4v1586945910722!5m2!1sen!2sin" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
    <!--FAQS AREA END-->
